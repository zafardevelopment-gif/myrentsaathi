...
const NAV_ITEMS: Record<MockRole, NavItem[]> = {
  superadmin: [
    ...
    { icon: "🏦", label: "Route Accounts", href: "/superadmin/route-accounts" },
  ...
  admin: [
    ...
    { icon: "🧾", label: "Invoices (Rent · Maint · Elec)", href: "/admin/billing" },
  ...
  landlord: [
    ...
    { icon: "🧾", label: "Invoices (Rent · Maint · Elec)", href: "/landlord/billing" },
